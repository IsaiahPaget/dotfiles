...
-- Nvim Tree
vim.keymap.set('n', '<leader>st', '<cmd>NvimTreeToggle<CR>', { desc = '[S]how Nvim[T]ree' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'blade', 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
